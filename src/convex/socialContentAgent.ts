...
// Re-export analytics and optimization functions from separate modules
export { recommendPostingTimes } from "./socialContentAgent/optimization";
export { suggestABTests } from "./socialContentAgent/optimization";
export { predictEngagement } from "./socialContentAgent/optimization";
export { repurposeContent } from "./socialContentAgent/optimization";
export { generateInsights } from "./socialContentAgent/analytics";
export { analyzeCompetitors } from "./socialContentAgent/analytics";
export { detectTrends } from "./socialContentAgent/analytics";
export { generateRecommendations } from "./socialContentAgent/analytics";