...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: <SystemAgentsPage />,
  },
  {
    path: "/branding",
    element: <BrandingPortal />,
  },
  {
    path: "/api-docs",
    element: <ApiDocsPage />,
