      ...
      >
        <Card className="w-full shadow-2xl rounded-2xl border-0 bg-white overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            {/* Show password form or email/social options */}
            {showPasswordForm ? (
              <>
                <PasswordAuthForm
              ...
              <>
                ...
                <Button
                  ...
                  disabled={authForm.isSubmitting}
                  className="w-full h-12 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg hover:shadow-xl transition-all font-semibold"
                >
