      ...
      <Card className="w-full neu-raised rounded-2xl border-0 shadow-xl bg-emerald-800 text-emerald-50">
        ...
        <div className="px-6 pb-4">
          <Button
            ...
            className="w-full neu-raised rounded-xl bg-white hover:bg-gray-100 text-gray-900"
            variant="outline"
          >
        ...
        <div className="px-6 pb-4">
          <div className="relative">
            ...
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-emerald-800 px-2 text-xs text-emerald-300">
              or
            </span>
          </div>
        </div>
        ...
        <div className="px-6 pb-4">
          <Button
            ...
            disabled={authForm.isSubmitting}
            className="w-full neu-flat rounded-xl bg-emerald-700 hover:bg-emerald-600 text-emerald-50"
            variant="outline"
          >
            Continue as Guest
          </Button>
