...
export function EnterpriseDashboard({ 
  ...
  return (
    <div className="space-y-6">
      {/* Global Overview */}
      <section>
        <h2 className="text-xl font-semibold mb-4">Global Command Center</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card>
            <CardContent className="p-4">
              <h3 className="text-sm font-medium text-muted-foreground">Global Revenue</h3>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold">{kpis.globalEfficiency}%</p>
              <p className="text-xs text-green-600">+3% from last quarter</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
              <h3 className="text-sm font-medium text-muted-foreground">Innovation Index</h3>
              <p className="text-2xl font-bold">{kpis.innovationIndex}</p>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold text-green-600">{kpis.riskScore}</p>
